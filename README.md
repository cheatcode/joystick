...
> **Node Warning**: Joystick is best used with Node.js 16-18 (v19+ will cause apps without .js extensions on imports to break). If you don't have Node.js installed, or, want to learn how to manage multiple versions on one computer: [read this tutorial](https://cheatcode.co/tutorials/how-to-install-node-js-and-manage-versions-with-nvm).
