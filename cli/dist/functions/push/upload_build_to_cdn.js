...
var upload_build_to_cdn_default = async (build_timestamp = "", deployment = {}, session_token = "") => {
  const first_available_mirror = await get_first_available_mirror();
  const form_data = new FormData();
  form_data.append(
    "version_tar",
    fs.readFileSync(`.build/build.encrypted.tar.gz`),
...
export {
  upload_build_to_cdn_default as default
};
