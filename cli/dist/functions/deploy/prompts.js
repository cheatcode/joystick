...
`).addRow(chalk.blue("Load Balancers"), `${chalk.yellowBright(`(${answers?.loadBalancerInstances}x)`)} ${answers?.loadBalancer_size} ${chalk.gray(`[${answers?.loadBalancer_region}]`)} = ${chalk.greenBright(`$${loadBalancerCosts?.monthly}/mo`)}`).addRow(chalk.blue("App Instances"), `${chalk.yellowBright(`(${answers?.appInstances}x)`)} ${answers?.instance_size} ${chalk.gray(`[${answers?.instance_region}]`)} = ${chalk.greenBright(`$${instanceCosts?.monthly}/mo`)}

`).addRow(chalk.magenta("Est. Total Monthly Cost"), chalk.greenBright(`$${totalMonthlyCost}/mo`)).addRow(chalk.magenta("Est. Total Annual Cost"), chalk.greenBright(`$${totalAnnualCost}/yr`)).toString()}
