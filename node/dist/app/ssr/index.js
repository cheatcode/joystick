import k from"fs";import{parseHTML as o}from"linkedom";import v from"os";import O from"../api/get_api_for_data_functions.js";import N from"../../lib/get_browser_safe_request.js";import S from"../settings/load.js";import q from"./set_base_attributes_in_html.js";import J from"./set_head_tags_in_html.js";import u from"../../lib/path_exists.js";import x from"../accounts/get_browser_safe_user.js";const{readFile:h}=k.promises,c=S(),y=process.env.NODE_ENV==="development",{document:C}=o("<div></div>"),E=(e={})=>{let t=e?.base_html;if(e?.mod_theme){const a=o(t);a.document.querySelector("body").setAttribute("data-mod-theme",e?.mod_theme),t=a.document.toString()}const i=JSON.stringify(e?.data).replace(/</g,"\\u003c").replace(/-->/g,"--\\>").replace(/<\/script/gi,"<\\/script");return t.replace("${css}",`
