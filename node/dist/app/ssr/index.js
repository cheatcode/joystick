import w from"fs";import{parseHTML as g}from"linkedom";import j from"os";import k from"../api/get_api_for_data_functions.js";import v from"../../lib/get_browser_safe_request.js";import O from"../settings/load.js";import N from"./set_base_attributes_in_html.js";import S from"./set_head_tags_in_html.js";import m from"../../lib/path_exists.js";import"../../lib/tree_shake_mod_css.js";import J from"../accounts/get_browser_safe_user.js";import"../../lib/get_mod_css_from_map.js";const{readFile:o}=w.promises,l=O(),d=process.env.NODE_ENV==="development",{document:q}=g("<div></div>"),x=(e={})=>e?.base_html.replace("${css}",`
		...
		`).replace('<div id="app"></div>',`
			...
			<script>
				window.joystick = {
					settings: {
						global: ${JSON.stringify(l?.global)},
						public: ${JSON.stringify(l?.public)},
					},
				};
        ...
        window.__joystick_settings__ = ${JSON.stringify({global:l?.global,public:l?.public})};
