import O from"fs";import{parseHTML as d}from"linkedom";import S from"os";import x from"../api/get_api_for_data_functions.js";import N from"../../lib/get_browser_safe_request.js";import q from"../settings/load.js";import J from"./set_base_attributes_in_html.js";import E from"./set_head_tags_in_html.js";import u from"../../lib/path_exists.js";import A from"../accounts/get_browser_safe_user.js";import p from"../../lib/escape_html.js";import i from"./escape_ssr_data.js";const{readFile:y}=O.promises,c=q(),h=process.env.NODE_ENV==="development",{document:C}=d("<div></div>"),D=(e={})=>{let t=e?.base_html;if(e?.mod_theme){const r=d(t);r.document.querySelector("body").setAttribute("data-mod-theme",e?.mod_theme),t=r.document.toString()}return t.replace("${css}",`
