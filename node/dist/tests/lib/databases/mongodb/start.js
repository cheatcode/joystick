...
var start_default = async () => {
  ...
  const result = execSync(`mongod --port ${parseInt(process.env.PORT, 10) + 1} --dbpath ./tests/.data/mongodb --quiet --fork --logpath ./tests/.data/mongodb/log`);
